...
public class AccountConfig : IEntityTypeConfiguration<Account>
{
    public void Configure(EntityTypeBuilder<Account> builder)
    {
        ...
        builder.HasData(
            ...
            new Account { Id = 4, FullName = "Staff Thông", Email = "hoanganh@senik.com", Password = "@12345".Hash(), Role = AccountTypeEnum.Staff },
            new Account { Id = 5, FullName = "Staff Hoàng Anh", Email = "thong@senik.com", Password = "@12345".Hash(), Role = AccountTypeEnum.Staff }
